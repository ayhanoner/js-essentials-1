const employees = [
    { id: 1, name: 'John Doe', age: 30, department: 'IT', salary: 60000, specialization: 'JavaScript' },
    { id: 2, name: 'Alice Smith', age: 28, department: 'HR', salary: 50000, specialization: 'Python' },
    { id: 3, name: 'Bob Johnson', age: 35, department: 'Finance', salary: 70000, specialization: 'Java' },
];
...
function findEmployeeById(employeeId) {
    ...
    if (foundEmployee) {
        ...
        document.getElementById('employeesDetails').innerHTML = `<p>Employee with ID ${employeeId} not found.</p>`;
    }
}
...
function findEmployeeBySpecialization(specialization) {
    ...
    if (foundEmployee) {
        document.getElementById('employeesDetails').innerHTML = `<p>${foundEmployee.id}: ${foundEmployee.name} - ${foundEmployee.department} </p>`;
    }
    else {
